...
function createPlan(planData) {
  ...
  const newPlan = {
    ...
    message: planData.message || 'Git contribution commit',
    authorName: planData.authorName || 'Git Contributor',
    authorEmail: planData.authorEmail || 'contributor@example.com',
    schedule,
